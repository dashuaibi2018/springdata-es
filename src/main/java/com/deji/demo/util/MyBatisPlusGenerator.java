...
//        gc.setOutputDir( "D:\\temp\\code");
        
		gc.setAuthor("mybatis-plus codegen");
...
//		pc.setModuleName("myDemo");
		pc.setParent("com.deji.demo");
		...
		focList.add(new FileOutConfig(templatePath) {
			...
			public String outputFile(TableInfo tableInfo) {
				...
				String filename = projectPath + "/src/main/resources/mapper/"
